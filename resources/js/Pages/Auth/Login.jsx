        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#0a1f44] rounded-2xl p-8 shadow-2xl border border-[#152a4e]">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300">Sign in to your QuizHive account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center">
                <div className="relative flex items-center">
                  ...
                  <div className="h-5 w-5 border border-[#1d3a6a] rounded flex items-center justify-center mr-2">
                    {rememberMe && <CheckCircle className="h-4 w-4 text-yellow-400" />}
                  </div>
              ...
              <button
                type="submit"
                className="w-full px-4 py-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-[#0a1f44] rounded-xl hover:from-yellow-300 hover:to-yellow-400 transition-all font-medium shadow-lg shadow-yellow-500/20"
              >
                Sign In
              </button>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#0a1f44] text-gray-300">Or continue with</span>
              </div>
            </div>
